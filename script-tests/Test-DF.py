...
def send_data(full_DF):
    ...
    datetime_df.insert(0, "datetime_id", range(1, len(datetime_df) + 1))
    ...
    parameter_df.insert(0, "parameter_id", range(1, len(parameter_df) + 1))
    ...
    location_df.to_csv(r'..\datasets\results\location_df.csv')
    datetime_df.to_csv(r'..\datasets\results\datetime_df.csv')
    parameter_df.to_csv(r'..\datasets\results\Result-Parameter.csv')
    fact_df.to_csv(r'..\datasets\results\Result-Fact.csv')
