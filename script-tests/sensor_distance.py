...
def find_traffic_sensors_within_radius(loc_df, radius_km=5.0):
...
locations_DF = pd.read_sql(query, my_connector)

print(find_traffic_sensors_within_radius(locations_DF))